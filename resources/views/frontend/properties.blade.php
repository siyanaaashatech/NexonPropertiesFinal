...
<form action="{{ route('frontend.searching') }}" method="GET" class="container-fluid py-5 propertiesfinder">
    <div class="container">
        ...
        <div class="justify-content-center align-items-center gap-2 flex-wrap hiddenform" id="hiddenform">
            ...
            <div class="d-flex flex-column col-md-3">
                <label for="" class="sm-text1 des-text">Select Subcategory</label>
                <select type="text" class="input bannerinput" name="region" placeholder="Regions"
                    value="{{ request('region') }}">
            ...
            <div class="d-flex flex-column col-md-3">
                <label for="" class="sm-text1 des-text">Select States</label>
                <select type="text" class="input bannerinput" name="region" placeholder="Regions"
                    value="{{ request('region') }}">
        ...
        @endif
            ...
            <div class="d-flex flex-column col-md-3">
                <label for="" class="sm-text1 des-text">Select regions</label>
                <select type="text" class="input bannerinput" name="region" placeholder="Regions"
                    value="{{ request('region') }}">
            ...
            <div class="d-flex flex-column col-md-3">
                <label for="" class="md-text1 des-text">keyboard</label>
                    ...
                    @foreach ($properties as $property)
                                        <a class="col-md-4 my-2" href="{{route('singleproperties', ['id' => $property->id])}}">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <h5 class="md-text">{{strlen($property->title)>32 ? substr($property->title ,0 ,32). "...":$property->title }}</h5>
...
</script>@extends("frontend.layouts.master")
@section("content")
