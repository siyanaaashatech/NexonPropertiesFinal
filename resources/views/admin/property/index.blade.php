        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.property.create') }}" class="btn btn-primary float-end">Add New Property</a>
                </div>
                <div class="card-body">
                    @if(session('success'))
                                ...
                                @foreach($properties as $property)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.property.destroy', $property->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this property?');">
                                                @csrf
                                                @method('DELETE')
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('admin.metadata.update', $property->metadata->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                    ...
                    @else
                        <div class="alert alert-info">
                            No properties available. <a href="{{ route('admin.property.create') }}">Create a new property</a>.
                        </div>
                    @endif
                </div>
            </div>
